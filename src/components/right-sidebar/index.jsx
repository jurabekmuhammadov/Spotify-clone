        ...
        <aside className={`h-full w-1/6 bg-black p-2 flex flex-col gap-2 transition-all fixed top-0 right-0 ${isRightSidebarOpen ? "" : "w-28"}`}>
            ...
            <div className={`top bg-zinc-900 rounded-lg p-4 ${isRightSidebarOpen ? "w-full" : "w-full py-4 px-0"}`}>
                <ul className="flex flex-col gap-5">
                    ...
                    <li className="w-full menu-item">
                        <NavLink to={"/search"} className={`w-full flex items-center gap-4 text-zinc-500 transition-all ${isRightSidebarOpen ? "" : "justify-center"}`}>
            ...
            <div className={`bottom bg-zinc-900 rounded-lg p-2 pt-3 overflow-auto ${isRightSidebarOpen ? "w-full" : "w-full py-4 px-0"} h-screen flex items-end justify-start flex-col`}>
                <button onClick={handleRightSidebarToggle} className={`w-full flex justify-end ${isRightSidebarOpen ? "" : "justify-center"}`}>
                    {isRightSidebarOpen ? <PanelRightOpen color="gray" size={26} /> : <PanelLeftOpen color="gray" size={26} />}
                </button>
            </div>
        </aside>
    )
